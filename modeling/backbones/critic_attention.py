...
from .critic_value import Ctritic_Value

WEIGHT_PATH = '/home/aistudio/work/myproject/Relation-Aware-Global-Attention-Networks/reid/models/weights/pre_train/resnet50-19c8e357.pth'
print(WEIGHT_PATH)
...
class Critic_Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.maxpool(x)
        x1 = self.layer1(x)
        att_x1,a1 = self.rga_att1(x1)
        self.value1=Ctritic_Value(x1,a1)
        v1=self.value1(x1,a1)

        x2 = self.layer2(att_x1)
        att_x2,a2 = self.rga_att2(x2)
        self.value2 = Ctritic_Value(x2, a2)
        v2=self.value2(x2,a2)

        x3 = self.layer3(att_x2)
        att_x3,a3 = self.rga_att3(x3)
        self.value3 = Ctritic_Value(x3, a3)
        v3=self.value3(data=x3,a=a3)

        x4 = self.layer4(att_x3)
        att_x4,a4 = self.rga_att4(x4)
        self.value4 = Ctritic_Value(x4, a4)
        v4=self.value4(data=x4,a=a4)
        return att_x4,[v1,v2,v3,v4]
